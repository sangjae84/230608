...
# # int 변환은 숫자 그자체로 넣었을 때만 인식 (오십오 X)
...
# # 예 : 아메리카노 카페라떼 (또는) 해바라기 장미
# print(a)
# print(b)

# a, b = input('문자열 두 개를 입력하세요: ').split(',')
# # split(',') -> 입력받은 값(input)을 구분자(,) 기준으로 분리
# # 예 : 아메리카노,카페라떼 (또는) 해바라기,장미
# print(a)
# print(b)

# a, b, c = input('문자열 세 개를 입력하세요: ').split()
# # split() -> 입력받은 값(input)을 구분자(' ') 기준으로 분리
# # 예 : 아메리카노 카페라떼 루이보스차 (또는) 해바라기 장미 수국
# print(a)
# print(b)
# print(c)
...
# print(a + b) # 30
# a와 b에 같은 작업을 했는데... -> a, b, c로 늘어나...? 3번. a,b,c,d...? 4번.
